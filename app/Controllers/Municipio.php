...
class Municipio extends ResourceController
{
    ...
    public function index()
    {
        ...
        if (isset($data)  && (count($data) > 1)) {
            foreach ($data as $value) {
                $data = [
                    'cod' => newGuid(),
                    'provincia_cod' => isset($value->provincia_cod) ? $value->provincia_cod : null,
            ...
            $data = [
                'cod' => newGuid(),
                'provincia_cod' => isset($data->provincia_cod) ? $data->provincia_cod : null,
    ...
    {
        $data = [
            'municipio' => $this->model->where('cod', $cod)->first(),
